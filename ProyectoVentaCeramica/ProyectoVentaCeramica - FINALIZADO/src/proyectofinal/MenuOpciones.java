...
public class MenuOpciones extends JFrame implements ActionListener{
	...
	public MenuOpciones() {
		...
		mntmCerrarSesion.setIcon(new ImageIcon(MenuOpciones.class.getResource("/imagenes/Imagen2.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == mntmCerrarSesion) {
			actionPerformedMuneOpcionCerrarSesion (e);
		}
	}
	
	public void actionPerformedMuneOpcionCerrarSesion(ActionEvent e) {
